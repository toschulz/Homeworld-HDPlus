...
/*-----------------------------------------------------------------------------
    ...
    Return      : bool32
----------------------------------------------------------------------------*/
bool32 rmCanBuildShip(Player *player, ShipType type)
{
...
void rmUpdateResearch(void)
{
    ...
    bool32                shipcanbuild[STD_LAST_SHIP];
...
/*-----------------------------------------------------------------------------
    ...
    Return      : void
----------------------------------------------------------------------------*/
void rmInitializeResearchStruct(Player *player, bool32 candoresearch, sdword techlevel)
{
    sdword index;
