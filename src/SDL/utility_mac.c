/*=============================================================================
    ...
    Modified in September 2023 by atsb for macOS specific handling
=============================================================================*/
...
void utyOptionsFileRead(void)
{
    ...
    char *application_support_dir = SDL_GetPrefPath("", "Raider Retreat");
#else
    char *application_support_dir = SDL_GetPrefPath("", "Homeworld");
#endif
    ...
    {
        strcpy(ch_buf, application_support_dir);
...
{
    char* application_support_dir;
    char ch_buf[PATH_MAX];
    sdword index;
    FILE *f;

#ifdef HW_GAME_RAIDER_RETREAT
    application_support_dir = SDL_GetPrefPath("", "Raider Retreat");
#else
    application_support_dir = SDL_GetPrefPath("", "Homeworld");
#endif
...
#ifdef HW_GAME_RAIDER_RETREAT
    env_path = SDL_GetPrefPath("", "Raider Retreat");
#else
    env_path = SDL_GetPrefPath("", "Homeworld");
#endif
...
#ifdef HW_GAME_RAIDER_RETREAT
    char *dataPath = SDL_GetPrefPath("", "Raider Retreat");
#else
    char *dataPath = SDL_GetPrefPath("", "Homeworld");
#endif
...
#ifdef HW_GAME_RAIDER_RETREAT
        char *homeDir = SDL_GetPrefPath("", "Raider Retreat");
#else
        char *homeDir = SDL_GetPrefPath("", "Homeworld");
#endif
